...
xh = apl_2nd;
xh = apf_flt_1st(xh,       &(st->apf_1st[2]), &coef->apf_1st[1]);
    ...
    apl_2nd = apf_flt_2nd(l_f2, &(st->apf_2nd[4]), &coef->apf_2nd[0]);   
    apl_1st = apf_flt_1st(l_f2, &(st->apf_1st[4]), &coef->apf_1st[0]);
xh = apl_2nd;
xh = apf_flt_1st(xh,       &(st->apf_1st[5]), &coef->apf_1st[0]);
    res.band1 = flt_add(apl_2nd, apl_1st) * 0.5f;

        apl_2nd = apf_flt_2nd(res.band1, &(st->apf_2nd[6]), &coef->apf_2nd[0]);
        apl_1st = apf_flt_1st(res.band1, &(st->apf_1st[6]), &coef->apf_1st[0]);

    res.band1 = flt_add(apl_2nd, apl_1st) * 0.5f;
    res.band2 = xh - res.band1;

h_f2 = apf_flt_2nd(h_f2, &(st->apf_2nd[10]), &coef->apf_2nd[0]);
h_f2 = apf_flt_1st(h_f2, &(st->apf_1st[10]), &coef->apf_1st[0]);

    apl_2nd = apf_flt_2nd(h_f2, &(st->apf_2nd[7]), &coef->apf_2nd[2]);   
...
xh = apf_flt_1st(xh,       &(st->apf_1st[8]), &coef->apf_1st[2]);
    res.band3 = flt_add(apl_2nd, apl_1st) * 0.5f;
        ...
        apl_2nd = apf_flt_2nd(res.band3, &(st->apf_2nd[9]), &coef->apf_2nd[2]);
        apl_1st = apf_flt_1st(res.band3, &(st->apf_1st[9]), &coef->apf_1st[2]);

    res.band3 = flt_add(apl_2nd, apl_1st) * 0.5f;
    res.band4 = xh - res.band3;

        res.band1 = apf_flt_2nd(res.band1, &(st->apf_2nd[11]), &coef->apf_2nd[2]);
        res.band1 = apf_flt_1st(res.band1, &(st->apf_1st[11]), &coef->apf_1st[2]);

        res.band2 = apf_flt_2nd(res.band2, &(st->apf_2nd[12]), &coef->apf_2nd[2]);
        res.band2 = apf_flt_1st(res.band2, &(st->apf_1st[12]), &coef->apf_1st[2]);
